...
<?php
    ...
    setcookie("user_page", "doctorprofile.php", time()+(86400 * 30), "/", $servername);
  ...
  if (!$user) {
    ...
    if(isset($_COOKIE['cookie_id'])){
      ...
      $sql = "SELECT * FROM doctor_profile WHERE doctor_id = $id";
  ...
  <body class="spinner spinner-primary spinner-lg">
    <div class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">
            <center><h4 class="bg">DOCTOR</h4></center>
          </a>
        </div>
      ...
      <div class="container" style="background-color:#ffcccc">
          ...
          <center><h4>Doctor Information</h4></center>
            <form >
              <div class="form-group">
                <label for="formGroupExampleInput">Doctor ID</label>
                <div class="form-control" id="formGroupExampleInput"><?php echo $row["doctor_id"]; ?></div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-control" id="formGroupExampleInput"><?php echo $row["specialist"]; ?></div>
              </div>
