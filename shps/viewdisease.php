...
<?php
    ...
    setcookie("user_page", "viewdisease.php", time()+(86400 * 30), "/", $servername);
    ...
    <div class="signup" style="margin-top: 80px;">
      <div class="signup-body">
        <div class="signup-divider">
          <div class="divider">
            <div class="divider-content bg bg-info" class="btn btn-block" >View Disease</div>
          </div>
        </div>
       
      <center>
        <h3>List of All Diseases</h3>
      </center>
            ...
            <?php
              if($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) { ?>
                  <tr>
                    <th scope="row"><?php echo $row['disease_id'] ; ?></th>
                    <td><?php echo $row['disease_name']; ?></td>
                    <td><?php echo $row['symptoms']; ?></td>
                    <td><?php echo $row['types_of_disease']; ?></td>
                  </tr>
                <?php
                }
              }
