...
<?php
  ...
  setcookie("page", "adddiease.php", time()+(86400 * 30), "/", $servername);
          ...
          <center><h4>Add Disease</h4></center>
            <form action="db/action.php" method="post">
              <div class="form-group">
                <label for="formGroupExampleInput">Disease ID</label>
                <input type="text" name="disease_id" class="form-control" id="formGroupExampleInput" placeholder="Disease ID">
              </div>
              <div class="form-group">
                <label for="formGroupExampleInput2">Disease Name</label>
                <input type="text" name="disease_name" class="form-control" id="formGroupExampleInput2" placeholder="Disease Name">
              </div>
              <div class="form-group">
                <label for="formGroupExampleInput">Symptoms</label>
                <input type="text" name="symptoms" class="form-control" id="formGroupExampleInput" placeholder="Symptoms">
              </div>
               <div class="row gutter-xs">
              <div class="col-xs-12">
                <div class="form-group">
                  <label for="gender">Type of disease</label>
                  <select id="gender"  name="types_of_disease"  class="custom-select" data-msg-required="Please indicate your gender." required>
                    <option value="" disabled="disabled" selected="selected">Select...</option>
                    <option value="CORONA">CORONA</option>
                    <option value="AIDS">AIDS</option>
                    <option value="INFLUENGSA">INFLUENGSA</option>
                  </select>
                </div>
              </div>
            </div>
             <button class="btn btn-info btn-block" name="btn_adddisease" type="submit" style="margin-bottom: 10px;">ADD</button>
            </form>
       </div>
