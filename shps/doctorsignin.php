        ...
        <div class="login-form">
          <form data-toggle="validator" action="db/action.php" method="post">
            <div class="form-group">
              ...
              <input id="email" class="form-control" type="text" name="txtEmail" spellcheck="false"  data-msg-required="Please enter your email address." required>
            </div>
            <div class="form-group">
            ...
            <button class="btn btn-primary btn-block" name="btnsignin_doctor" type="submit">Sign in</button>
